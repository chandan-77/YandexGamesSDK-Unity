...
namespace PlayablesStudio.Plugins.YandexGamesSDK.Runtime.Modules.Leaderboard
{
    public interface ILeaderboardModule
    {
        ...
        void GetLeaderboardEntries(string leaderboardName, int quantityTop, int quantityAround, bool includeUser, Action<List<LeaderboardEntry>, string> callback = null);
