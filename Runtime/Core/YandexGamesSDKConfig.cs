...
namespace PlayablesStudio.Plugins.YandexGamesSDK.Runtime.Dashboard
{
    ...
    public sealed class YandexGamesSDKConfig : ScriptableObject
    {
        private const string CONFIG_PATH = "YandexGamesSDKConfig";
        private static YandexGamesSDKConfig _instance;
        
        public static YandexGamesSDKConfig Instance
        {
            get
            {
                if (_instance == null)
        ...
        {
            _instance = Resources.Load<YandexGamesSDKConfig>(CONFIG_PATH);
            
            if (_instance == null)
            {
                Debug.LogWarning($"[YandexGamesSDK] Config not found at Resources/{CONFIG_PATH}. Using default settings.");
                _instance = CreateInstance<YandexGamesSDKConfig>();
            }
        }
        ...
        public MockDataSettings mockData;
